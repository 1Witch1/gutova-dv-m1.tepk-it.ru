...
@section('content')
    ...
    <form action="{{route('materials.store')}}" method="post">
        ...
        <div class="d-flex card">
            ...
            <input type="number" min="0" step="1" name="quantity_stock" required>
        </div>
        <div class="d-flex card">
            <p>Минимальное количество</p>
            <input type="number" min="0" step="1" name="min_quantity" required>
        </div>
        <div class="d-flex card">
            <p>Количество в упаковке</p>
            <input type="number" min="0" step="0.01" name="quantity_package" required>
        </div>
        <div class="d-flex card">

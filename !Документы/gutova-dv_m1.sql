...
CREATE TABLE `materials` (
  ...
  `min_quantitytity` int NOT NULL,
  `quantity_package` decimal(18,2) NOT NULL,
...
INSERT INTO `materials` (`id`, `name`, `material_type_id`, `price`, `quantity_stock`, `min_quantitytity`, `quantity_package`, `unit_id`) VALUES
(1, 'Цельный массив дерева Дуб 1000х600 мм', 1, 7450.00, 1500, 500, 7.20, 1),
...
(5, 'ДСП 2750х1830 мм', 2, 529.60, 1010, 1200, 181.08, 1),
(6, 'МДФ 2070х1400 мм', 2, 417.24, 1550, 1000, 87.00, 1),
(7, 'ДВП 2440х2050 мм', 2, 187.00, 1310, 1000, 190.00, 1),
(8, 'ХДФ 2800x2070 мм', 2, 370.96, 1400, 1200, 90.00, 1),
...
(16, 'Колесо для мебели поворотное', 6, 10.59, 1500, 1000, 500.00, 3),
...
(20, 'Кромка ПВХ', 6, 35.80, 1500, 1000, 100.00, 4);
...
INSERT INTO `material_types` (`id`, `name`, `loss`) VALUES
(1, 'Дерево', 0.55),
